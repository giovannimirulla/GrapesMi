...
function importRepos(contents) {
    ...
    for (let content of contents) {
        ...
        if (content.size !== 0) {
            ...
            card.setAttribute('href', "/hw1/project?q=" + content.Nome.toLowerCase())
...
const contentsDiv = document.querySelector('#projects .main');
fetch("api/projects.php?limit=4&random").then(onResponse, onError).then(onJsonUser) //.catch(onError)