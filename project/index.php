...
$project = trim(mysqli_real_escape_string($conn, $_GET['q']));
$res_2 = mysqli_query($conn, "SELECT ID FROM Progetto WHERE Nome = '$project'");
if (empty($project) || mysqli_num_rows($res_2) == 0) {
    header("Location: /hw1");
}
